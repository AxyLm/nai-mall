...
export default {
    ...
    methods:{
        ...
        // 增加和修改操作
        clickAdd(){ 
            this.modelTitle = "会员 - 新建";
            this.showDetail = true;
            this.$nextTick(_=>{
                this.$refs.memberDetail.init();
            });
        },
        clickEdit(row){ 
            this.modelTitle = "会员 - 修改";
            this.showDetail = true;
            this.$nextTick(_=>{
                this.$refs.memberDetail.init(row.id);
            });
        },
        ...
        clickDel(row){
            this.$confirm("确定删除吗？").then(_=>{
                let api = this.$http.api.member.delete(row.id);
        ...
        clickDelMany(){
            ...
            let api = this.$http.api.member.batchDelete();
            this.$http.callApi(api,{
                data:{
