<template>
    <div class="store">
        ...
        >
            ...
            <el-table-column prop="area_code" label="地区编码" show-overflow-tooltip></el-table-column>
            <el-table-column prop="area_info" label="省市县区" show-overflow-tooltip></el-table-column>
            <el-table-column prop="street_info" label="街道信息" show-overflow-tooltip></el-table-column>
        ...
        <div v-if="showDetail">
            <el-dialog :title="modelTitle" :visible.sync="showDetail" width="50%" :close-on-click-modal="false" :close-on-press-escape="false">
                <StoreDetail ref="storeDetail" @close="clickCloseDetail"></StoreDetail>
            </el-dialog>
        </div>
    </div>
</template>
