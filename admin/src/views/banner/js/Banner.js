...
export default {
    ...
    methods:{
        ...
        getPage(){
            ...
            let api = this.$http.api.banner.getPage();
        ...
        clickEdit(row){ 
            ...
            this.showDetail = true;
            this.$nextTick(_=>{
                this.$refs.bannerDetail.init(row.id);
            });
        },
        ...
        clickDel(row){
            this.$confirm("确定删除吗？").then(_=>{
                let api = this.$http.api.banner.delete(row.id);
        ...
        clickDelMany(){
            ...
            let api = this.$http.api.banner.batchDelete();
            this.$http.callApi(api,{
                data:{
        ...
        clickDeletedSwitch(row){
            let api = this.$http.api.banner.updateDeleted(row.id);
            this.$http.callApi(api,{
                data:{
                    deleted:row.deleted
                }
    ...
    computed:{
        rights(){
            return this.$store.state.rights.goods.banner;
        }
    },
    components:{
        BannerDetail
